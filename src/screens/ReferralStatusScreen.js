...
export default function ReferStatusScreen({ navigation }) {
  // Referral status list containing only user name, coin earned, and task completed status (/5)
          ...
          {(referralsList || []).map((item) => (
            <View key={item.id} style={styles.historyCard}>
              ...
              <View style={styles.coinBadge}>
                <Ionicons name="logo-bitcoin" size={12} color="#1A1A1A" style={{ marginRight: 3 }} />
